...
const A713 = () => {
  ...
  const productFeatures = [
    "Hemispheric dome camera with fisheye, dewarped, and ePTZ viewing modes",
    "Simultaneous triple streams",
    "Integrated heater",
    "IR cut filter for day and night switching",
    "CBR and VBR",
    "Mirror and rotation (corridor mode 90, 180, 270°) image orientation",
    "Image enhancements include: white balance, brightness, contrast, sharpness, saturation, automatic gain control, and backlight compensation",
    "Built-in tampering detection",
    "Additional features include: 2D-DNR/3D-DNR, 120 dB wide dynamic range, privacy masking, text overlay, reset button, digital I/O, and manual setting GPS position",
    "Compatible with Edge (IE mode), Chrome, and Firefox",
  ];
     ...
     <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <header className="bg-[#7f95b8] text-white py-12 px-6 text-center">
        <h1 className="text-3xl md:text-5xl font-bold max-w-4xl mx-auto leading-tight">
         A713 5MP Outdoor Network Fisheye Dome Camera with Night Vision and Heater
        </h1>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            ...
            A high-security surveillance camera with wide area coverage, night vision, and also two-way audio            </p>

            <h2 className="font-bold text-xl mb-2  text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
             Keep a watchful eye over your property with the A713 5MP Outdoor Network Fisheye Dome Camera from ACTi. This unit uses a progressive scan CMOS image sensor to capture 1920 x 1920 resolution video at 30 fps. An adaptive IR LED provides up to 16′ of night vision. The camera’s 1.1mm fisheye fixed lens delivers a 180° horizontal field of view. Two-way audio is possible thanks to an audio input and output. An onboard memory card slot accepts microSD/SDHC/SDXC cards (available separately). Integrated PoE technology simplifies connectivity by transferring data and power through a single cable.              </p>
