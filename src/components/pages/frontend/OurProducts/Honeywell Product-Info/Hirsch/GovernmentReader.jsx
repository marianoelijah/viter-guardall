        ...
        <main className="lg:w-3/4 bg-gray-300 p-8 shadow-sm">
             ...
             <table className="w-full border-collapse border border-gray-500 text-[10px]">
                <thead>
                   <tr className="bg-gray-100 font-bold">
                      ...
                      <th className="border border-gray-500 p-2 text-[17px] text-gray-800">TS Mullion HF PoC</th>
                      <th className="border border-gray-500 p-2 text-[17px] text-gray-800">TS Mullion HF PoC</th>
                   </tr>
                </thead>
                <tbody>
                  <tr>
                   ...
                   <tr>
                      ...
                      <td colSpan="4" className="border border-gray-500 p-2 text-[17px] text-gray-800 text-center">
           ...
           <div className="mb-8">
             ...
             <table className="w-full border-collapse border border-gray-500 text-[10px]">
                ...
                <tbody>
                   <tr>
                      <td className="border border-gray-500 p-2 text-[17px] text-gray-800 font-bold bg-gray-50">Port Numbers</td>
                      <td colSpan="1" className="border border-gray-500 p-2 text-[17px] text-gray-800 text-center">
          ...
          <div>
            ...
            <table className="w-full border-collapse border border-gray-500 text-[10px]">
              <thead>
                <tr className="bg-gray-100 font-bold">
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800 text-left w-1/4"></th>
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800">HF</th>
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800">HF/LF</th>
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800">HF/LF PoE</th>
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800">HF PoE</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="border border-gray-500 p-2 text-[17px] text-gray-800">
                    13.56 MHz</td>
                  <td colSpan="2" className="border border-gray-500 p-2 text-[17px] text-gray-800 text-center">
