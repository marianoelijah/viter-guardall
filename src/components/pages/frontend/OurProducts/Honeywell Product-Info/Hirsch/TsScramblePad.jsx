      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
          ...
          <section className="mb-8">
            <h2 className="font-bold text-xl text-black mb-2 uppercase">Product Description:</h2>
            ...
            <h2 className="font-bold text-xl text-black mb-2 uppercase">Product Features:</h2>
            ...
            <table className="w-full border-collapse border border-gray-500 text-[10px]">
              <thead>
                <tr className="bg-gray-100 font-bold">
                  ...
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800 ">TS ScramblePad SC Wiegand</th>
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800">TS ScramblePad SC RS-485/OSDP</th>
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800">TS ScramblePad SC SCFICAM</th>
                  <th className="border border-gray-500 p-2 text-[17px] text-gray-800">TS ScramblePad SC FICAM-Strict</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-gray-500 p-2 font-bold bg-gray-100 text-xl">Part Numbers</td>
                  <td className="border border-gray-500 bg-gray-200 p-2 text-[17px]">8336ABT0000</td>
                  <td className="border border-gray-500 bg-gray-200 p-2 text-[17px]">8336ABTR000</td>
                  <td className="border border-gray-500 bg-gray-200 p-2 text-[17px]">8336ABTF000</td>
                  <td className="border border-gray-500 bg-gray-200 p-2 text-[17px]">8336ABTFF00</td>
                </tr>

                <tr>
                  <td className="border border-gray-500 p-2 text-[17px] text-gray-800 font-bold bg-gray-100">
                    Carrier Frequencies
                  </td>
                  <td colSpan="3" className="border border-gray-500 bg-gray-200  text-[15px] text-gray-800 p-2">
                    125 kHz / 13.56 MHz
                  </td>
                  <td className="border border-gray-500 p-2 text-[15px] bg-gray-200 text-gray-800">
                    13.56 MHz
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-500 p-2 text-[17px] text-gray-800 font-bold bg-gray-100">Reader Output</td>
                  <td className="border border-gray-500 text-[15px] text-gray-800 bg-gray-200 p-2">Wiegand</td>
                  <td colSpan="3" className="border border-gray-500 p-2 text-[15px] bg-gray-200 text-gray-800">RS-485 (2 Wire)</td>
                </tr>
                <tr>
                  <td className="border border-gray-500 p-2 text-[17px] text-gray-800 font-bold bg-gray-100">Current Consumption (@ 12 V)</td>
                  <td colSpan="2" className="border border-gray-500 text-[15px] text-gray-800 p-2 bg-gray-200">270 mA typical; 300 mA Peak</td>
                  <td colSpan="2" className="border border-gray-500 p-2 text-[15px] text-gray-800 bg-gray-200">@ 48V: 68 mA typical; 82 mA Peak</td>
                </tr>
                <tr>
                  <td className="border border-gray-500 p-2 text-[17px] text-gray-800 font-bold bg-gray-100">
                    Power Supply
                  </td>
                  <td colSpan="4" className="border border-gray-500 p-2 text-[15px] bg-gray-200 text-gray-800">
                ...
                <tr>
                  ...
                  <td colSpan="4" className="border border-gray-500 bg-gray-200 p-2 text-[15px] text-gray-800">
                    Black
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="border border-gray-500 p-2 text-[17px] text-gray-800 font-bold bg-gray-100">
                    High FrequencyCompatibility
                  </td>
                  <td colSpan="3" className="border border-gray-500 text-[15px] text-gray-800 bg-gray-200 p-2">
                ...
                <tr>
                  ...
                  <td colSpan="3" className="border border-gray-500 p-2 text-[15px] bg-gray-200 text-gray-80">
                ...
                <tr>
                  ...
                  <td className="border border-gray-500 p-2 text-[15px] text-gray-800 bg-gray-200 ">
                    No
                  </td>
                  <td className="border border-gray-500 p-2 text-[15px] text-gray-800 bg-gray-200">
                    Upgradable
                  </td>
                  <td colSpan="2" className="border border-gray-500 p-2 text-[15px] text-gray-800">
                    Yes
                  </td>
                </tr>
                <tr>
                  ...
                  <td colSpan="4" className="border border-gray-500 p-2 text-[15px] text-gray-800 bg-gray-200">
                    Two (2) years
                  </td>
                </tr>
                 <tr>
