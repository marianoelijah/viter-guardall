...
const Dvsdv = () => {
  const data = {
    ...
    subtitle: "A dual-view x-ray system to provide complete inspection of items in a single scan.",
    description: "The 6040DVS-DV X-ray scanner delivers a clear picture of hidden explosives, weapons, drugs and other contraband in hand-carried and small- to mid-sized items. This dual-view system displays two separate, perpendicular X-ray images to provide a complete inspection in a single scan. Compact and easy to use, the 6040DVS-DV delivers best-in-class speed, accuracy and reliability, and makes the most of available space.",
    features: [
      "Dual-view design provides more detailed information in one scan",
      "Folded array rapidly images full mailbags and long or tall items",
    ...
    //   { label: 'Dvsdv', value: 'Indoor Dome: IEC  60529 IP54, IEC/EN 62262 IK11 (IK10 Surface Mount w/IR)', valu: "Outdoor Dome:IEC 60529 IP66, IP67, IP68 (2m depth for 2 hours), IPX9K, NEMA 4X, IEC 60068-2 Shock & Vibration, NEMA TS2 Sec 2.2.7-2.2.9, IK11" },
