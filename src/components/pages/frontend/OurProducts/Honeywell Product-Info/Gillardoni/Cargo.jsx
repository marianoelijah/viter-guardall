...
const Cargo = () => {
  const specs = [
    ...
    { label: "Dimensions [Mm]", value: "750 (L) x 308 (W) x 246 (H)"},
    { label: "Weight [Kg]", value: "4300" },
    ...
    { label: "Consumption [Kw]", value: "4.5kVA" },
    ...
    { label: "Resolution", value: "40 AWG" },
    { label: "Penetration", value: "50mm" },
    ...
    <Header />
     <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <header className="bg-[#7f95b8] text-white py-12 px-6 text-center">
        <h1 className="text-5xl md:text-5xl lg:text-4xl font-bold max-w-4xl mx-auto leading-tight">
          FEP CARGO
        </h1>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            ...
            Designed for screening pallets and large packages, this x-ray system is suitable for high-security cargos.
            </p>

            <h2 className="font-bold text-xl mb-2  text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
             The new FEP ME CARGO DV is a multi-energy X-ray system suitable for screening goods on pallets up to 3000 kg. It has one 200kV X-ray source and a large inspection tunnel opening of 180cm x 180cm. The FEP ME CARGO DV allows detection of organic materials (including explosives and drugs), and of weapons, detonators and dangerous objects representing threats to security. Multi-energy technology allows the screen to display the nature of different materials inside the inspected objects using a chromatic code. 
               </p>
