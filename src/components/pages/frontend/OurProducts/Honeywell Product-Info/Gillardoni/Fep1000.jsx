...
const Fep1000 = () => {
  const specs = [
    ...
    { label: "Dimensions [Mm]", value: "337,4 (L) x 173,6 (W) x 202,6 (H)"},
    { label: "Weight [Kg]", value: "1400" },
    ...
    { label: "Max Load On Conveyor [Kg]", value: "2000" },
    
    // { type: 'header', label: 'IMAGING' },
    { label: "Belt Height [Mm]", value: "376" },
    { label: "Belt Speed [M/S]", value: "0,2 " },
    { label: "Monitor [Nr]", value: "2" },
    { label: "Power Supply", value: "230Vac ± 10% 50Hz" },
    { label: "Consumption [Kw]", value: "2" },
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
             An x-ray system designed for large baggage and cargo screening.          
            </p>

            <h2 className="font-bold text-xl mb-2  text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
                 One of the larger X ray machines that Gilardoni manufacturer, the ME 1000 has a belt height of 376mm and maximum bag/parcel weight of 200kg, the 160 kv generator has a diagonal downwards beam which can penetrate up 35mm of steel and its resolution is 38 AWG guaranteed. 
              </p>
