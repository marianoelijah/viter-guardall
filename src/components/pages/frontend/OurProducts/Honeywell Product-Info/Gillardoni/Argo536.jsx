...
const Argo536 = () => {
  const specs = [
    ...
    { label: "Dimensions [Mm]", value: "1364 (L) x 800 (W) x 1200 (H) mm"},
    { label: "Weight (standard module)", value: "335 kg" },
    { label: "Tunnel size", value: "530 (W) x 330 (H) mm" },
    { label: "Conveyor belt height", value: "715,5mm, adjustable" },
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
               A compact x-ray inspection system that provides high-level security screening for baggage and parcels, best suitable for buildings with limited spaces.
            </p>

            <h2 className="font-bold text-xl mb-2  text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
                 ARGO 536 is designed to examine baggage, mails and parcels at the entrance to delimited areas, ensuring high levels of security. The system complies with the highest quality standards in the industry to guarantee fully safety in use and high reliability. Advanced algorithms an image on the large monitor for a complete view of the scanned item and an incredible detection capability. Thanks to its extremely small dimensions, ARGO 536 is suitable for buildings where the available space is limited, moreover it can be implemented with additional accessories and software for a wide range of use.
               </p>
