...
const   NT4100PTIRZ2 = () => {
  ...
  const productFeatures = [
    ...
    "25x(4.8~120mm) optical zoom",
    "Low luminance 0Lux (IR LED on)",
    "Smart IR / IR distance Max. 100m",
    "Deep-learning Engine",
    "AI-based object detection and tracking (person/vehicle)",
    "Applying stealth technology",
    "H.265 / H.264",
    "DC 12V / PoE+(802.3.at)",
    "IP66",
  ];
     ...
     <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <header className="bg-[#7f95b8] text-white py-12 px-6 text-center">
        <h1 className="text-5xl md:text-5xl font-bold max-w-4xl mx-auto leading-tight">
           NT4100PT-IR-Z2.5W Intelligent Network Camera
        </h1>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            ...
            A high-security pan-tilt-zoom camera with 25x Optical Zoom. It has reliable results even in low-light environments.
            </p>
