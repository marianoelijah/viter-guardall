...
const NK1080BLIR48 = () => {
  ...
  const productFeatures = [
    "1/2.8“, 2.1M Sony STARVIS Image Sensor",
    "Supports 2 H.264 streams including 1920×1080 30fps and 1 JPEG stream",
    "Max 6 streams connection simultaneously (3 users based on NVR)",
    "A3DNR (Noise reduction)",
    "Digital Image Stabilizer (DIS)",
    "True Day & Night (ICR)",
    "Support De-Fog function",
    "One-push Auto focus, zoom/focus control",
    "Supports Onvif / PoE",
    "Supports IPv4",
    "IP66 Level Protection against Dust and Water",
    "Internal IR distance: 60m"
     ...
     <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <header className="bg-[#7f95b8] text-white py-12 px-6 text-center">
        <h1 className="text-3xl md:text-5xl font-bold max-w-4xl mx-auto leading-tight">
           NK1080BL-IR48-AF Network Camera
        </h1>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
              A high-security surveillance system that provides clear images in low light condition. 
            </p>
