...
const WizSense = () => {
  const data = {
    ...
    subtitle: "This surveillance camera features endless panning, a 0 to 90 tilt range, and 32x optical zoom. ",
    description: "Securely monitor your surroundings with the WizSense Series 52C432GBNR 4MP Network PTZ Dome Camera from Dahua Technology. This unit uses a 1/2.8″ progressive scan CMOS sensor to capture 2560 x 1440 resolution video at 30 fps. A 4.8-154mm varifocal lens delivers a 55.8 to 2.3° horizontal field of view. This camera features endless panning, a 0 to 90° tilt range, and 32x optical zoom. Two-way audio is possible thanks to an audio input and output. A memory card slot accepts microSD/SDHC/SDXC cards up to 512GB (available separately). Integrated PoE technology simplifies connectivity by enabling the transfer of power and data through a single cable.",
    features: [
      "2560 x 1440 Resolution at 30 fps",
      "4.8-154mm Varifocal Lens",
      "55.8 to 2.3° Horizontal Field of View",
      "Endless Panning & 0 to 90° Tilt Range",
      "32x Optical Zoom",
      "Two-Way Audio",
