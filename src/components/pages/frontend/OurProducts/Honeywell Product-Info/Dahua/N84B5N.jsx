...
const N84B5N = () => {
  const data = {
    ...
    subtitle: "Powered with a powerful processor and built-in analytics chip, this network video recorder can accommodate up to 32 channels.",
    description: "The 32-Channel AcuPick 8K Network Video Recorder from Dahua Technology is designed with a powerful processor to support high access and forwarding bandwidth and strong decoding capabilities to produce unimpeded streams. Thanks to its built-in analytics chip and Dahua’s advanced deep learning algorithms, the NVR supports a variety of analytics functions, such as AcuPick, high-precision Face Detection+, and Perimeter Protection to shorten the response time to events and make videos more interactive. The NVR features four SATA ports supporting up to a 16TB HDD each. This model does not include an HDD, so that you can install your own as your needs require. The NVR also has one eSATA port.",
    features: [
      ...
      "4 x SATA Ports / 1 x eSATA Port",
      "Up to 16-Channel Recording/Playback",
      "2 x RJ45 Network Ports",
