            ...
            <table className="w-full border text-[15px] text-black">
              <tbody>
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                      24-port PoE 2.0 ManagedGigabit Switch
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
...
const CompliantCompliant = () => {
  const data = {
    title: "DH-S4228-24GT-360 28-Port Gigabit PoE++ Compliant Compliant Managed Network Switch",
    subtitle: "A high-speed network switch capable of supporting up to 28 devices with its ports. ",
    description: "Increase your business’s capacity for advanced IP security cameras, access points, and other power-over-Ethernet compatible devices with the S4228-24GT-360 28-Port Gigabit PoE++ Compliant Managed Network Switch from Dahua Technology. This Gigabit speed managed Layer 2 desktop switch features two 90W PoE++ ports and twenty-two 30W ports, with a total budget of 360W. There are also two non-PoE RJ45 ports alongside dual SFP fiber uplink slots.",
    features: [
      "2 x Gigabit Ethernet Ports",
      "2 x Gigabit Ethernet PoE++ Ports (90W)",
      "22 x Gigabit Ethernet PoE+ Ports (30W)",
      "2 x Gigabit SFP Ports",

      "56 Gb/s Switching Capacity",
      "41.664 Mbps Forwarding Rate",
      "360W Power Budget",
      "Desktop Mountable",
      "Layer 2 Features",
      "Up to 820.2′ Range (Extend Mode)"
    ],
...
export default CompliantCompliant;