...
const CompliantManaged = () => {
  const data = {
    title: "DH-S4220-16GT-240 16-Port Gigabit PoE++ Compliant Managed Network Switch",
    subtitle: "A high-performance network switch capable of supporting up to 16 devices with its ports.",
    description: "Grow your business’s network capacity with the DH-S4220-16GT-240 16-Port Gigabit PoE++ Complaint Managed Network Switch from Dahua Technology. This managed Layer 2 switch features 16 Gigabit Ethernet ports, two of which support up to 90W PoE while the rest provide up to 30W each, delivering both power and data to IP cameras, access points, and other compatible devices over a single cable.",
    features: [
      "14 x Gigabit Ethernet PoE+ Ports (30W)",
      "2 x Gigabit Ethernet PoE++ Ports (90W)",
      "2 x Gigabit SFP Ports",
      "56 Gb/s Switching Capacity",

      "29.76 Mbps Forwarding Rate",
...
export default CompliantManaged;