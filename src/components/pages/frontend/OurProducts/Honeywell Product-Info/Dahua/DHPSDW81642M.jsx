            ...
            <table className="w-full border text-[15px] text-black">
              <tbody>
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                     Panoramic: 8 x 1/1.8-in. 2MP CMOSPTZ: 1/1.8-in. 4MP CMOS
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                     Panoramic: 5 mmPTZ: 5.6 mm to 223 mm
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                     Panoramic: 0.01 lux at F2.0PTZ: 0.008 lux at F1.3
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    Pan: 0 ̊ to 360 ̊, endlessTilt: -20 ̊ to 90 ̊Auto flip: 180 ̊
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                     Pan: 0.1° /s to 240° /sTilt: 0.1° /s to 120° /s
                  </td>
                </tr>
                 <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                     Motion, Tripwire, Intrusion, Smart Tracking
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                 ...
                 <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                     Micro SD,Max 512GB (panoramic only)
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
...
const DHPSDW81642M = () => {
  const data = {
    ...
    subtitle: "A high-speed surveillance camera that can provide a 360° panoramic view of your property. ",
    description: "The Panoramic Network Camera + PTZ Camera can splice up to a 360° horizontal view to give you a wider view. Working with high-speed PTZ, the camera can display the details. With advanced video analysis algorithms, the camera supports linkage between panorama and details, and situation analysis.",
    features: [
      "Channel 1 (Panoramic): 8 × 2 MP 1/1.8″ CMOS image sensors. Field of View:Horizontal: 1 × 360°, Vertical: 103°.",
