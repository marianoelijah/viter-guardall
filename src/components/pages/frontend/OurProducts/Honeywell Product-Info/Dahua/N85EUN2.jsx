            ...
            <table className="w-full border text-[15px] text-black">
              <tbody>
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    Enhanced Night Color131 ft (40 m)White-light LEDs
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    Perimeter Protection,People Counting, Face Detection,Smart Motion Detection+
                  </td>
                </tr>
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                      1/1 + Built-in Microphone; Speaker: Bullet only
                  </td>
                </tr>
                 <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
...
const N85EUN2 = () => {
  const data = {
    ...
    subtitle: "A cost-effective surveillance camera that can capture 4K UHD videos and record full color video in low-light conditions.",
    description: "Monitor an indoor or outdoor area with the N85EUN2 8MP ePoE Night Color Network Turret Camera from Dahua Technology. This unit uses a 1/1.2″ progressive scan CMOS sensor to capture 4K UHD resolution video at 30 fps. Two white-light LEDs provide up to 131′ of illumination to record full color video in low-light conditions. The camera’s 2.8mm fixed lens delivers a 102° horizontal field of view. Two-way audio is possible thanks to a built-in microphone, along with an RCA audio input and output. A memory card slot supports microSD cards up to 256GB (available separately). Integrated ePoE technology offers a cost-effective solution for transmitting power and data over long distances via Ethernet or coaxial cables when compared to running separate wires.",
    features: [
      "3840 x 2160 Resolution at 30 fps",
      "2 White LEDs for Illumination up to 131′",
      "2.8mm Fixed Lens",
