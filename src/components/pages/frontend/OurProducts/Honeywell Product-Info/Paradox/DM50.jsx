...
const DM50 = () => {
  const productData = {
    ...
    subtitle: "This device has a dual detection technology ensuring accurate intruder detection while minimizing false alarms.",
    description: "Paradox DM50 is a Dual Element Passive Infrared Motion Detector module compatible with Paradox Digiplex EVO panels. It connects to the EVO combus, and features digital auto pulse signal processing and Digital Shield algorithm software to improve reliability and reduce false alarms.",
    features: [
