...
const ZX82 = () => {
  const productData = {
    ...
    subtitle: "This divide provides up to 8 additional hardwired zones inputs, as well as on-board anti-tamper switch.",
    description: "The Paradox ZX82 zone expansion module provides up to eight additional hardwired zone inputs and is compatible with all Paradox panels. The ZX82 comes mounted in its own ABS enclosure and includes Status LED indication for power, data and for each individual zone.",
    features: [
