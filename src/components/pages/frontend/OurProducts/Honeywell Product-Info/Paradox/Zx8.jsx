...
const Zx8 = () => {
  const productData = {
    ...
    description: "The Paradox 8-zone Expansion Module (ZX8) is an interface between the control panels and any hardwired detection devices. The ZX8 connects to the alarm control panel’s combus to provide eight additional hardwired inputs and one 50mA on-board PGM output.",
    features: [
                ...
                <table className="w-full text-[15px] text-black border-collapse border border-black">
                   ...
                   <tr>
                    ...
                    <tr>
                      ...
                      <td colSpan="3" className="border border-black p-2">
                          PCB:14 cm x 4.5 cm x 1.8 cm(5.5 in x 1.8 in x 0.7 in)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-black p-3 font-bold w-1/2">
