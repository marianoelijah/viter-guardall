...
const K10H = () => {
  const productData = {
    ...
    subtitle: "An easy-to-use keypad that provides simple control for your Paradox security system.",
    description: "The Paradox K10H is a 10-zone LED keypad compatible with the MG/SP series control panels. It features Paradox’s innovative key light display, in which the keypad buttons light up to display various information. For example, an open zone will be indicated by the keypad number being illuminated which corresponds to the zone number. The trouble and memory buttons illuminate to indicate information available.",
    features: [
