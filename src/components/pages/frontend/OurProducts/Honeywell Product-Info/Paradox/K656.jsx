...
const K656 = () => {
  const productData = {
    ...
    subtitle: "This sleek, touchpad can help arm or disarm your systems easily.",
    description: "The K656 Touch Sense LCD Keypad provides touchpad technology with simplified menu-driven navigation. Whether arming or disarming your system, bypassing zones, or viewing the system status, the menu-driven prompts guide you every step of the way. The sleek, innovative K656 Touch Sense LCD Keypad makes using your security system easier than ever.",
    features: [
      "Touch Sense keys with LED backlighting",
      "32-character blue LCD screen",
      "Streamlined, compact design",
      "Zone alarm display",
      "In-field firmware upgradable via Paradox InField",
