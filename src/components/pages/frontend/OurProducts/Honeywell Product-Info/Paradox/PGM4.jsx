...
const PGM4 = () => {
  const productData = {
    ...
    subtitle: "Expand the capabilities of your Paradox security system with the PGM4 Programmable Output Expansion Module. ",
    description: "The Paradox PGM4 is an expansion module with four fully programmable relay outputs. Each output contains a normally open (NO) and normally closed (NC) contact rated at 5A. The PGM4 is compatible with Digiplex, EVO, Spectra, Esprit E55, and MG / SP systems.",
    features: [
      "Compatible with E55/E65, MG/SP, and EVO systems",
      "Relay outputs rated at 5A",
                ...
                <table className="w-full text-[15px] text-black border-collapse border border-black">
                   ...
                   <tr>
                    ...
                    <tr>
                      ...
                      <td colSpan="3" className="border border-black p-2">
                          PCB:14 cm x 4.5 cm x 3 cm(5.5 in x 1.8 in x 1.2 in.)
                      </td>
                    </tr>
                     <tr>
                      <td className="border border-black p-3 font-bold w-1/2">
