...
const WattAmplifier125 = () => {
  const specs = [
    { label: "IP rating", value: "IP20 (acc. EN 60529)"}, 
    { label: "Output power", value: "125 W RMS" },
    { label: "Power supply", value: "AC main power supply: 100–240 VAC (50–60 Hz, max. 170 W)DC backup power supply: 24 VDC (21–28 VDC, max. 6.5 A)" },
    ...
    { label: "Total harmonic distortion (THD+N)", value: " 0.2% at 1 kHz sine at 125 W" },
    { label: "Signal-to-noise ratio (SNR)", value: "amplifier: > 110 dBcodec G.722: > 80 dB" },
    { label: "Cabling", value: "min. Cat. 5" },
    { label: "Connection", value: "2 RJ45 modular jacks (IP uplink and IP downlink)outputs, inputs, microphone 3), line out: pluggable screwterminals (0.08–1.5 mm2/AWG 28–16)loudspeaker output: pluggable screw terminals(0.75–4 mm2/AWG 20–12, class 2 wiring)AC main power supply (IEC-60320-C14)DC backup power supply: 1.5–6 mm2/AWG 16–10,external fuse with 8 A" },
    ...
    { label: "Outputs", value: "relay output (changeover contact): max. 60 W (DC)/37.5 VA (AC), max. 2 A 4), max. 60 VDC/30 VACeffexpected life: min. 105 (30 VDC/2 A), 5 x 105 (30 VDC/1 A)" },
    { label: "Control input", value: "0 – 10 V (for remote volume control)" },
    { label: "Operating temperature range", value: "−10 °C to +50 °C (+14 °F to +122 °F)" },
    ...
    { label: "Weight incl. package", value: "approx. 3,400 g (7.5 lbs)" }
  ];

  const productFeatures = [
    "125 watts total output power",
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
              A 125 Watt amplifier with metal housing.
            </p>

            <section className="mb-8">
              <h2 className="font-bold text-xl mb-2 text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
               The AF 125H provides a high output range and various connections from a microphone input 
               to a relay output. That’s why the amplifier is universally suitable for any size of 
               application – even for complex public address and Intercom solutions. In order to avoid 
               cabling costs and be more flexible, the AF 125H is specifically optimized for installation 
               either in a 19” rack or on-site.
              </p>
...
export default WattAmplifier125;