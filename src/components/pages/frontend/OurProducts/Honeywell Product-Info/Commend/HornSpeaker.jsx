      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
              A Public Address loudspeaker designed for rough, industrial conditions such as industrial 
              sites and railway stations.
            </p>

            <section className="mb-8">
              <h2 className="font-bold text-xl mb-2 text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
                The IP horn loudspeaker AFLS 10H HG is designed specifically to provide reliable voice signal transmission under rough indoor and outdoor conditions (e.g. at industrial areas and railway stations). Thanks to the built-in microphone and the IVC feature (Intelligent Volume
              </p>
               <p className="text-gray-800 text-[17px] leading-relaxed">
                Control), it is possible to adjust the volume automatically to the ambient noise – even during playback.
              </p>
