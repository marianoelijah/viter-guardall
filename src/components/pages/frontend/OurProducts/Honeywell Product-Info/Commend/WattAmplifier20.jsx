      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
             A 20 Watt amplifier with polycarbonate housing.
            </p>

            <section className="mb-8">
              <h2 className="font-bold text-xl mb-2 text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
                Their compact design makes the 20 Watt amplifiers ideal for a decentralized, cable saving installation next to PA loudspeakers and Intercom terminals. To provide even greater flexibility, the analogue amplifiers are available as add-in modules that integrate easily into the Intercom terminals themselves.
              </p>
...
export default WattAmplifier20;