...
const CeilingSpeaker = () => {
  const specs = [
    { label: "IP rating", value: "IP54 (acc. EN 60529)"},
    { label: "Mechanical impact resistance", value: "IK09 (acc. EN 62262)" },
    { label: "Housing", value: "metal" },
    { label: "Loudspeaker", value: "15 W, 4 Ω" },
    { label: "Sound pressure level", value: "max. 105 dB" },
    ...
    { label: "Output", value: "relay output (switch-over contact) 2)max. 60 W (DC)/37.5 VA (AC),max. 2 A,max. 60 VDC/30 VACexpected life: min. 5 x 104 (2 A), 105 (1 A)" },
    ...
    { label: "Approvals and compliances", value: "EN 55032 Class A, EN 55024EN 60529 IP54EN 60950-1, EN 62368-1 Clause 8, UL 62368-1UL Listed, FCC Part 15 Class A, ICES-003 Class A" },
     ...
     <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <header className="bg-[#7f95b8] text-white py-12 px-6 text-center">
        <h1 className="text-5xl md:text-5xl font-bold max-w-4xl mx-auto leading-tight">
          AFLS 10H CW: IP Ceiling Speaker
        </h1>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
             This fitted loudspeaker is designed for installation in drywall ceilings and buildings.
            </p>

            <section className="mb-8">
              <h2 className="font-bold text-xl mb-2 text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
                The AF 500H provides a high output range and various connections from a microphone input 
                The IP ceiling loudspeaker AFLS 10H CW is designed specifically to provide reliable voice 
                signal transmission under indoor conditions (e.g. schools, meeting rooms and hotels). 
                As it can be used as IoIP device or as SIP device (hybrid), the loudspeaker integrates 
                easily into any Voice over IP system as well as any existing Commend Intercom system.
              </p>
