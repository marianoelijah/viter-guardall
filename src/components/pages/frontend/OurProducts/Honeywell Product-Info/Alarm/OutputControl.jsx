...
const OutputControl = () => {
  const specs = [
    { label: "Input power", value: "12 to 24 VDC ±10%,500 mA max"},
    { label: "Communication", value: "Shielded 2-wire RS-485" },
    { label: "Inputs", value: "2 unsupervised/supervised programmable inputs, standard EOL: 1k/1kΩ, 1%, 1⁄4 watt, one dedicated input for each ofthe following: Tamper, AC Fail, Battery Fail" },
    { label: "Outputs", value: "Twelve Form-C relay outputs: 2 A @ 30 VDC resistive" },
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
              Designed to work with X1100 Door Controllers, this expansion module adds 12 additional outputs and two additional outputs. 
            </p>
            ...
            <section className="mb-8">
              ...
              This platform enables intelligent automation and features, such as disarming when badging in, 
              locking doors when arming, and tagging access events on the video timeline 
              </p>
              <p className="text-gray-800 text-[17px] leading-relaxed">
              The X300 Output Control Expansion Module adds support for twelve additional outputs and
              two additional inputs to an Alarm.com X1100 Door Controller.
              </p>
