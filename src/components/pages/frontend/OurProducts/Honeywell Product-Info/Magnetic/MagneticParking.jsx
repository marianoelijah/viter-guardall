            ...
            <table className="border text-[15px] w-full">
              <tbody>
                <tr className="bg-gray-300 font-bold ">
                  <td colSpan="1" className="border-r border-black border p-2 ">
                  </td>
                ...
                <tr className="bg-gray-300 font-bold">
                  ...
                  <td colSpan="2" className="border-black  p-2 border text-black">
                      315 x 360 x 915 mm
                  </td>
                  <td colSpan="2" className="border-black  p-2 border text-black">
                      315 x 360 x 1115 mm
                ...
                <tr className="bg-gray-300 font-bold">
                  ...
                  <td colSpan="4" className="border-black  p-2 border text-black">
                    	44 kg
                  </td>
                </tr>
...
const MagneticParking = () => {
  const data = {
    title: "Magnetic Parking / Parking-M",
    subtitle: "Designed for heavily frequented parking facilities, this parking barrier has an optional folding boom",
    description: "In a multi-storey car park or an underground garage, Parking barriers from Magnetic are the ideal solution for professional parking applications. Thanks to their configuration and security settings, Parking Barriers are designed for use in heavily frequented facilities in which the movement of persons can be ruled out. Rapid opening times and the detection of tailgating vehicles ensure reliable processing for users, while low energy consumption, low-maintenance components and simple servicing keeps running costs down permanently. ",
    features: [
      "Reliable detection of tailgating vehicles",
      "Low power consumption for economical operation",
      "Optimum accessibility for particularly easy maintenance",
      "German Design Award 2014 and red dot design award 2012",
...
export default MagneticParking;