          ...
          <div className="lg:col-span-3">
            ...
            <table className="border text-[15px] w-full">
              <tbody> 
                ...
                <tr className="bg-gray-300 font-bold">
                  <td colSpan="1" className="border-r border-black border text-black p-2 ">
                    Height of Barrier Elements
                  </td>
                  <td colSpan="5" className="border-black  p-2 border text-gray-700">
                     Standard: 888 mm High: 1800 mm (more on request)
                  </td>
                </tr>
                ...
                <tr className="bg-gray-300 font-bold">
                  ...
                  <td colSpan="5" className="border-black  p-2 border text-gray-700">
                    0.6 –1 s, depending on barrier element dimensions
                  </td>
                </tr>
                <tr className="bg-gray-300 font-bold">
                  <td colSpan="1" className="border-r border-black border text-black p-2 ">
                    Flow rating (number of persons per min.)
                  </td>
                  <td colSpan="5" className="border-black  p-2 border text-gray-700">
                    approx. 40
                  </td>
...
const MWingPedestrian = () => {
  const data = {
    title: "MWing Pedestrian Passageway with Wing Gates",
    subtitle: "A high-security yet elegant pedestrian passageway that  allows non-contact passage. ",
    description: "High visitor numbers, wheelchair-friendly access, escape routes during emergencies – a single gate is often insufficient to meet all the requirements. But here, too, the extremely slender design and uniform stylistic language of FlowMotion® gates prove advantageous because they allow the particularly simple implementation of space-saving multiple applications. Several gates can be arranged in rows to enable the rapid and reliable control of large numbers of visitors. With mWing, mSlide and mFlap we offer left, central and right modules with adapted barrier elements; a housing is available for mTripod without barrier elements for the end of a row.",
    features: [
...
export default MWingPedestrian;