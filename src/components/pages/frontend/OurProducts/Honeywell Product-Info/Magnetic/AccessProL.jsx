...
const AccessProL = () => {
  const data = {
    ...
    description: "At the entrances of companies, building sites, port facilities and other secured areas – the Access Pro-H from Magnetic is the ideal solution in all cases where traffic control is necessary and pedestrian access must also be reliably prevented. A boom skirt and climb-over prevention effectively stop intruders climbing over or crawling under the barrier. With their low impact forces, these barriers are also approved for locations where the movement of people can be expected (when the stipulated safety equipment is installed).",
    features: [
