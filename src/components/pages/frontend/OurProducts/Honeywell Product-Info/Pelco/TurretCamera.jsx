    ...
    <div className="bg-gray-100 min-h-screen font-sans text-black pb-12">
      ...
      <header className="bg-[#7f95b8] text-white py-12 px-4 text-center">
        <h1 className="text-5xl md:text-5xl font-bold tracking-tight max-w-4xl mx-auto text-center">
             Sarix Value Series IR Environmental Turret Camera (ITV529-1ERS)
        </h1>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
          <p className="text-[17px] leading-relaxed mb-6">
           A cost-effective, dome-shaped camera that can provide maximum coverage even in total darkness. 
          </p>
          ...
          <section className="mb-8">
            ...
            <div className="text-[17px] leading-relaxed space-y-4 mb-6">
              <p>
                Sarix Value ITV Series cameras are easy to install with a bubble-less design, saving time and money. The Sarix Value Series features excellent image quality with great low light performance, color fidelity and true wide dynamic range (WDR) for increased visibility in difficult lighting situations. And with built-in IR illumination, the camera can provide coverage even in total darkness. The vari-focal lensing gives you the flexibility to set a range of fields of view.
              </p>
            </div>
          ...
          {/* Tags */}
            ...
            <p className="text-lg text-white border bg-red-500 px-2">PELCO</p>
