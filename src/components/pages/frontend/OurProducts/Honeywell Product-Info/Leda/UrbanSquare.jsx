...
const UrbanSquare = () => {
  const productData = {
    ...
    subtitle: "A sleek bollard designed to seamlessly blend with the surrounding while still providing light at night. ",
                ...
                <table className="w-full text-[15px] text-black border-collapse border border-black">
                   ...
                   <tr>
                      ...
                      <td colSpan="3" className="border border-black p-2">
                         Material: Mild steel – 150 UC mild steel             
                         Stainless steel – 10mm plate             
                         Hardwood – Range of options available

                         Finish: Hot dipped galvanized / linished (Level 4)
                      </td>
                    </tr>
