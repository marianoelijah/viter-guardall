...
const Rack = () => {
  const specs = [
    ...
    { label: "Design", value: "Rack-style sharp spikes"},
    { label: "Installation", value: "Mounted on fences, walls, or gates"},
    { label: "Fixings", value: "Anti-vandal bolts" },
    { label: "Coating", value: "Galvanized + optional protective coating" },
    { label: "Applications", value: "Military, prisons, industrial, high-security compounds" },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
                The ClearVu Spike Rack is an innovative system of wall spikes designed using the latest
                anti-scale technology which are widely used in the protection of embassies, public buildings,
                industrial zones and commercial establishments across the world.
            </p>

            <section className="mb-8">
              <h2 className="font-bold text-xl mb-2 text-black">Product Description:</h2>
              <p className="text-gray-800 text-[17px] leading-relaxed">
                A barrier adition option for ClearVu fences, walls, and gates. Provides extreme anti-climb deterrence
                with sharp, rack-like spikes. It offers a visual warning and physical barrier against unauthorized
                access. Manufactured from high-toughened steel, resistant to cutting and tampering.
              </p>
