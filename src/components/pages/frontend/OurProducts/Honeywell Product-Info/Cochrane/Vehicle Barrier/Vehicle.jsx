      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
                The Vehicle Barrier is Designed to integrate seamlessly with high-security 
                fencing, these barriers provide a robust physical deterrent for critical 
                infrastructure, combining structural strength with a clean, low-profile 
                aesthetic.
            </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-800 text-[17px] leading-relaxed">
               The Cochrane AVB is a passive (fixed) or active (movable) barrier system. 
               It is primarily used to protect critical national infrastructure, data centers, 
               and government buildings. Its unique selling point is the "Integrated Security" 
               design—it doesn't just sit in front of the fence; it is often built into the 
               fence structure to provide a unified aesthetic and physical defense.
              </p>
