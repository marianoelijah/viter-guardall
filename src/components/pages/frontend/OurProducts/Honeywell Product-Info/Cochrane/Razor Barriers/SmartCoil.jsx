...
const SmartCoil = () => {
  const specs = [
    ...
    { label: "Format", value: "Coiled razor barrier"},
    { label: "Deployment", value: "Rapid, flexible installation"},
    ...
    { label: "Integration", value: "ClearVu fences, Razor Mesh, Electric Smart Coil" },
    { label: "Applications", value: "Military, border control, industrial, emergency response" },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
                Flexible Razor Coil Security - a versatile, rapid-deployment razor barrier for
                perimeter defense.
            </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-800 text-[17px] leading-relaxed">
                Constructed from Cochrane Ripper Blade razor wire in a coiled format. Can be deployed quickly 
                for temporary or permanent perimeter security. Used in military operations, border control,
                industrial sites. Compatible with ClearVu fences, Razor Mesh, and Electric Smart Coil for 
                layered defense.
              </p>
