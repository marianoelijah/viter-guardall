...
const RDBarrier = () => {
  const specs = [
    ...
    { label: "Format", value: "Modular portable barrier units"},
    { label: "Deployment Time", value: "Minutes (by small teams)"},
    ...
    { label: "Application", value: "Military, riot control, border enforcement, disaster response" },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main className="lg:w-3/4 bg-gray-200 p-8 shadow-sm">
            <p className="text-gray-800 text-[17px] mb-6">
                Instant Razor Barrier Protection - a portable quick-install perimeter
                defense solution.
            </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-800 text-[17px] leading-relaxed">
                Designed for rapid deployment in emergies or temporary perimeter needs. Constructed from
                Cochrane Ripper Blade razor wire in modular barrier units. Can be deployed by small 
                teams without heavy equipment.
              </p>
