...
const Trillium = () => {
  const productData = {
    title: "Trillium RFID",
    subtitle: "Designed with a one-piece module, this hotel lock can be accessed with RFID and DirectKey mobile access. ",
    description: "Designed for today’s modern aesthetics, Onity’s Trillium lock is available in a stylish one-piece module design with a low profile reader, RFID and optional Bluetooth® Low Energy (BLE) configurations. Trillium locks can be operated using Onity’s DirectKeyTM technology enabling guests to use an approved smartphone app to securely download their assigned key for easy access to controlled areas.",
    features: [
      "Simple to use",
      ...
      "Special weather kits for outdoors",
                ...
                <table className="w-full text-[15px] text-black border-collapse border border-black">
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td colSpan="3" className="border border-black p-2">
                       1.5 VDC 4x AA alkaline batteries (for interior applications) or lithium batteries (for non-fire rated exterior applications)
                      </td>
                    </tr>
                     <tr>
                      <td colSpan="2" className="border border-black p-3 font-bold w-1/2">
                      ...
                      <td colSpan="3" className="border border-black p-2">
                        Controlled side of door in electronics module
                      </td>
                    </tr>
                      <tr>
                      <td colSpan="2" className="border border-black p-3 font-bold w-1/2">
