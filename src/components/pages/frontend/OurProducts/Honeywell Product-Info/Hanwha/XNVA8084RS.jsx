...
const XNVA8084RS = () => {
  const data = {
    title: "XNVA-8084RS 4CH mini AI Camera",
    description: "The Hanwha Vision XNVA-8084RS is a compact 4-channel AI-powered multi-directional dome camera designed for advanced surveillance, offering object classification, loitering detection, and enhanced cybersecurity in a smaller, discreet form factor. It’s ideal for both indoor and outdoor environments such as banks, schools, hospitals, and retail spaces. ",
    features: [
      "4CH AI Analytics",
