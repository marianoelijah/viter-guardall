...
const DS2CD2T43G2 = () => {
  const data = {
    ...
    subtitle: "A bullet-style, 4MP surveillance camera that can accurately detect human or vehicle motion/target.",
    description: "Empowered by deep learning algorithms, Hikvision AcuSense technology brings human and vehicle targets classification alarms to front- and back-end devices. The system focuses on human and vehicle targets, vastly improving alarm efficiency and effectiveness.",
    features: [
