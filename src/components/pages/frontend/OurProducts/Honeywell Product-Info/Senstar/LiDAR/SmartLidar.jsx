...
const SmartLidar = () => {
  const data = {
    ...
    subtitle: "Smart 3D LiDAR is designed for advanced physical security applications. It offers dependable threat detection and minimizes false alarms by generating high-density 3D data, processed directly on-device. With its weather-resistant design and consistent performance in diverse lighting conditions, this solution is ideal for both indoor and outdoor environments.",
    ...
    features: [
      "Reduce False Alarm",
      "Detect in Challenging Conditions",
      "Protect Privacy",
      "Seamless Integration with VMS",
      "Multiple Uses",
      "Object Tracking"
    ],
  };
