...
const IntercomAccessControl = () => {
  const productData = {
    ...
    features: [
      ...
      "Cross-functional management unifying door locks, transit pathways, and elevator calls."
    ],
  };
              ...
              <tbody>
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    13, 56 MHz, ID CARD, 2MP Facial Recognition,and Digital Keyboards
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    Outfitted with dedicated muti output relays for pysical electronic lock triggers
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    Supports standalone, networked, or  PC based controller architecture configurations.
                  </td>
                </tr>
...
export default IntercomAccessControl;