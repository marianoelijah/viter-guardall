...
const Communication = () => {
  const data = {
    ...
    subtitle: "A multi-purpose communication card compatible with conventional control panels. ",
    description: "The TED-151-2PE multi-purpose communication card is compatible with conventional CCD-100 control panels and CAD-150 analogue control panels. It provides the integrator, installer or maintainer with various connectivity options in a single communication card.",
    features: [
