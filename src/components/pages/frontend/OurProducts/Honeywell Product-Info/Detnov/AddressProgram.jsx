              ...
              <tbody>
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    Automatic and sequential device addressing
                  </td>
                </tr>
                <tr className="bg-gray-300 ">
                  <td colSpan="2" className="border-r border-black border p-2 font-bold w-1/2">
                ...
                <tr className="bg-gray-300 ">
                  ...
                  <td colSpan="3" className="border border-r border-black  p-2">
                    Input: 230Vca/0,35A Output: 28Vcc/0,89A
                  </td>
                </tr>
...
const AddressProgram = () => {
  const data = {
    title: "PGD-201 Address Programmer",
    subtitle: "A tool that is used to assign addresses to each device in the loop of fire alarm systems. ",
    description: "The PGD-201 address programmer is an addressable system tool that is used to assign addresses to each device in the loop. The range of addresses is from 1 to 250, not having to save any kind of address range for detectors or modules. The PGD-201 programmer takes into account that there are loop devices that can occupy more than one address, being detected and making the reservation of the necessary addresses, to not duplicate addresses in the system automatically.. ",
    features: [
      "Hand-held tool",
