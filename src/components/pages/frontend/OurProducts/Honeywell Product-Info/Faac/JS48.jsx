...
const JS48 = () => {
  const productData = {
    ...
    features: [
      ...
      "The FAAC JS48 bollards are certified to stop a 7,500 kg truck driven at 50 km/h, with certified operation even after impact. Safety standards complied with: PAS 68, IWA 14-1, ASTM F2656. "
    ],
    moreByBrand: [
