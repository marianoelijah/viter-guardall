...
const J275 = () => {
  const productData = {
    ...
    subtitle: "Designed to help regulate vehicular access to commercial, industrial, and urban restricted areas",
    description: "The Automatic retractable traffic bollard J275 HA V2 is recommended for all areas when many daily transits are expected, i.e. commercial, industrial and urban restricted access areas.", 
    features: [
      "Guaranteed for high frequency use",
      "“Full optional” product; supplied equipped with the main accessories",
      ...
      "“Gentle stop” function to guarantee a soft impact while arriving on the low limit"
    ],
    moreByBrand: [
