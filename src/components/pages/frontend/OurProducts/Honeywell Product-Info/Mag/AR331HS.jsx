     ...
     <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-[#7f95b8] py-16 text-center">
        <h1 className="text-5xl md:text-5xl font-bold max-w-4xl mx-auto leading-tight">
          AR331HS Weather Proof Illuminated <br/>
               Touch-Panel Keypad
        </h1>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-gray-200 p-8 rounded-lg shadow-sm">
          ...
          <p className="text-gray-800 text-[17px] mb-6">
            AR331HS is a card access reader typically installed at the door to restrict unauthorized access. 
            It reads EM or Mifare proximity cards. It supports an RS485 connection, 3000 users and 1500 event 
            memory. It does not have a built-in keypad. Slim design to easily fit into a narrow door frame.
          </p>
