  ...
  return (
    <section className="bg-gray-50 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header Section */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4 uppercase">What We Do</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {services.map((service, index) => (
            <div key={index} className="flex flex-col items-start group">
              {/* Icon Circle */}
              <div className="w-16 h-16 bg-[#1e40af] rounded-full flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform duration-300">
                {service.icon}
              </div>
