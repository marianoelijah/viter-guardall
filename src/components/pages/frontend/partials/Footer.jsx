  ...
  return (
    <footer className="bg-white text-gray-800 border-t border-gray-200">
      <div className="container mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Logo & Description */}
        <div>
         <img src="" alt="Guard-All Logo" className="h-10 w-auto" />
          <p className="text-sm">
        ...
        {/* Company Links */}
        <div>
          <h3 className="text-blue-800 font-semibold mb-4">Company</h3>
        ...
        {/* Contact Info */}
        <div>
          <h3 className="text-blue-800 font-semibold mb-4">Contact Us</h3>
          <ul className="space-y-2 text-sm">
        ...
        {/* Offices & Social */}
        <div>
          <h3 className="text-blue-800 font-semibold mb-4">Offices</h3>
          <ul className="space-y-2 text-sm">
